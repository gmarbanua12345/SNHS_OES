    ...
    <div class="col-md-4">
      ...
      <section class="login-form"> <? echo check_message(); ?>
        ...
        <div class="form-links">
          ...
          <a href="index1.php"><button type="button" name="btnLogin" class="btn btn-lg btn-block" style="background:#008080; color:white">If you're a student, click here!</button></a>
        </div>
      </section>  
      </div>
